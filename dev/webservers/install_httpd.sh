...
<body>
    <center>
        ...
        <hr>
        <h1>
            This is a Dev enveironment provisioned by ACS730 Group 2 members<br>
            <br>
        ...
        <img src="https://acs730-final-project-group2-dev.s3.amazonaws.com/rashford.jpg" alt="Sample Image">
